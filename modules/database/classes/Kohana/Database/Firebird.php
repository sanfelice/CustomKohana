 ...
 * @copyright  (c) 2011 Paulo Henrique Pereira
 * @license    
 */
...
//		unset($this->_config['connection']['username'], $this->_config['connection']['password']);
		...
		try
		{
			...
			else
			{
				...
				$this->_connection = ibase_connect($hostname.":".$database, $username, $password);
	...
	public function query($type, $sql, $as_object)
	{
		...
		if ($type === Database::SELECT)
		{
			...
			return new Database_Firebird_Result($result, $sql, $as_object);
		}
